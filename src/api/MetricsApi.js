...
export class MetricsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/MetricNullablePointsResponse} and HTTP response
     */
    priceToEarningsWithHttpInfo(fullTicker, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'fullTicker' is set
      if (fullTicker === undefined || fullTicker === null) {
        throw new Error("Missing the required parameter 'fullTicker' when calling priceToEarnings");
      }
      ...
      let returnType = MetricNullablePointsResponse;

      return this.apiClient.callApi(
        '/stocks/metrics/pricetoearnings', 'GET',
     ...
     * @param {Number} opts.page The number of the page to request. (default to <.>)
     * @param {Number} opts.pageSize The number of elements in each page. Max value: 1000. (default to <.>)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/MetricNullablePointsResponse}
     */
    priceToEarnings(fullTicker, opts) {
      return this.priceToEarningsWithHttpInfo(fullTicker, opts)
