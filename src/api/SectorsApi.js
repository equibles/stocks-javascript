...
export class SectorsApi {
    ...
    */
     ...
     * @param {String} opts.sectorName The name of the sector to use as filter.
     * @param {String} opts.industryName The name of the industry to use as filter.
    ...
    searchStocksWithHttpInfo(opts) {
      ...
      let queryParams = {
        'sectorName': opts['sectorName'],'industryName': opts['industryName']
      };
      let headerParams = {
