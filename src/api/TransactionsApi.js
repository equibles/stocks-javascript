    ...
    */
    ...
    insidersWithHttpInfo(fullTicker, opts) {
      ...
      if (fullTicker === undefined || fullTicker === null) {
        throw new Error("Missing the required parameter 'fullTicker' when calling insiders");
      }
    ...
    institutionalWithHttpInfo(fullTicker, opts) {
      ...
      // verify the required parameter 'fullTicker' is set
      if (fullTicker === undefined || fullTicker === null) {
        throw new Error("Missing the required parameter 'fullTicker' when calling institutional");
      }
