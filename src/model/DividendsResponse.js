 ...
 * @version v1
 */
export class DividendsResponse {
  /**
 ...
 */
DividendsResponse.prototype.status = undefined;

/**
 * The error message if the request was not successful.
 * @member {String} errorMessage
 */
DividendsResponse.prototype.errorMessage = undefined;

/**
 * The response results.
 * @member {Array.<module:model/Dividend>} results
 */
DividendsResponse.prototype.results = undefined;

/**
 * The total number of results in this response.
 * @member {Number} count
 */
DividendsResponse.prototype.count = undefined;
