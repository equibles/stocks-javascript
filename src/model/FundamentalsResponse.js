 ...
 * @version v1
 */
export class FundamentalsResponse {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [FinancialReport]);
 ...
 */
FundamentalsResponse.prototype.status = undefined;

/**
 * The error message if the request was not successful.
 * @member {String} errorMessage
 */
FundamentalsResponse.prototype.errorMessage = undefined;

/**
 * The response results.
 * @member {Array.<module:model/FinancialReport>} results
 */
FundamentalsResponse.prototype.results = undefined;

/**
 * The total number of results in this response.
 * @member {Number} count
 */
FundamentalsResponse.prototype.count = undefined;
