  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [StockSplit]);
 ...
 */
SplitsResponse.prototype.status = undefined;

/**
 * The error message if the request was not successful.
 * @member {String} errorMessage
 */
SplitsResponse.prototype.errorMessage = undefined;

/**
 * The response results.
 * @member {Array.<module:model/StockSplit>} results
 */
SplitsResponse.prototype.results = undefined;

/**
 * The total number of results in this response.
 * @member {Number} count
 */
SplitsResponse.prototype.count = undefined;
