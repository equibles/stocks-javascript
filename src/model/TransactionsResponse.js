 ...
 */
TransactionsResponse.prototype.status = undefined;

/**
 * The error message if the request was not successful.
 * @member {String} errorMessage
 */
TransactionsResponse.prototype.errorMessage = undefined;

/**
 * The response results.
 * @member {Array.<module:model/Transaction>} results
 */
TransactionsResponse.prototype.results = undefined;

/**
 * The total number of results in this response.
 * @member {Number} count
 */
TransactionsResponse.prototype.count = undefined;
