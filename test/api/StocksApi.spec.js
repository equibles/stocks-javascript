...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EquiblesStocks.StocksApi();
  });
  ...
  describe('StocksApi', function() {
    ...
    describe('officers', function() {
      it('should call officers successfully', function(done) {
        //uncomment below and update the code to test officers
        //instance.officers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('profile', function() {
      it('should call profile successfully', function(done) {
        ...
        //instance.profile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('splits', function() {
      it('should call splits successfully', function(done) {
        ...
        //instance.splits(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
